...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i>Editar Servicio</h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            ...
            <form class="row" role="form" enctype="multipart/form-data" action="{{ route('servicio.update', ($servicio->id)) }}" method="POST">
