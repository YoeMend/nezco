...
<div class="app-title">
	<div>
		<h1><i class="fa fa-dashboard"></i> Crear Servicio</h1>
...
<div class="row">
 ...
 <form name="form1" class="row"  enctype="multipart/form-data" method="POST" action="{{route ('servicio.store')}}" accept-charset="UTF-8"><input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
				...
				<div class="form-group col-md-10">
					...
					<textarea class="form-control" rows="6" name="detalles" id="detalles" placeholder="Detalles"></textarea>
				</div>

				<div class="form-group col-md-3">
					<label class="control-label">Categoría servicio</label>
					<select id="categoria_servicio_id"  name="categoria_servicio_id" class="form-control">	
						<option value="">Seleccione Categoria servicio</option>
						@foreach ($categoriaservicio as $categ)
			...
			<div class="tile-footer">
						<button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{ route('servicio.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
