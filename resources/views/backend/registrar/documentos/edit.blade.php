...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Editar Documento</h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            ...
            <form class="row" role="form" enctype="multipart/form-data" action="{{ route('documento.update', ($documento->id)) }}" method="POST">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="text" name="nombre" id="nombre" placeholder="Título y/o Nombre" value="{{ $documento->nombre }}">
                </div>
                <div class="form-group col-md-10">
                    <label class="control-label">Descripción</label>
                    <textarea class="form-control" rows="6" name="descripcion" id="descripcion" placeholder="Descripción y/o Detalles">{{ $documento->descripcion }}</textarea>
                </div>
                <div class="form-group col-md-10">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control" type="text" name="categoria_documento_id" id="categoria_documento_id" placeholder="Título y/o Nombre" value="{{ $documento->categoria_documento_id}}" readonly="">
                   
                </div>
                <div class="form-group col-md-3">
                    <label class="control-label">Nombre</label>
                    
                    <input class="form-control" type="text" name="desc" value="{{ $descategoria }}">
        ...
        <div class="tile-footer">
            <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{ route('documento.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
